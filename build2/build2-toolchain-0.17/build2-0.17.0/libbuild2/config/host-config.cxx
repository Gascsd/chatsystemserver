...
config.config.environment = CPATH CPLUS_INCLUDE_PATH LIBRARY_PATH LD_RUN_PATH SOURCE_DATE_EPOCH GCC_EXEC_PREFIX COMPILER_PATH C_INCLUDE_PATH PATH=/usr/local/bin:/home/ubuntu/.vscode-server/cli/servers/Stable-e8653663e8840adaf45af01eab5c627a5af81807/server/bin/remote-cli:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin LD_LIBRARY_PATH
